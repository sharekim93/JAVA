...
class Collectin_Using implements ActionListener{
	...
	void add() {
		...
		if(text.contains(" ")||text.isEmpty()) {JOptionPane.showMessageDialog(null, "빈칸이 입력 되었습니다.\n확인해주세요");}
	...
	void showAll() {
		...
		if(text==""||text.isEmpty()) {JOptionPane.showMessageDialog(null, "입력된 값이 없습니다" );}
	...
	void get() throws Exception {
		...
		int i=0;
		text = gui.area.getText();
		if(text.contains(" ")||text.isEmpty()) {JOptionPane.showMessageDialog(null, "빈칸을 입력하셨습니다");}
